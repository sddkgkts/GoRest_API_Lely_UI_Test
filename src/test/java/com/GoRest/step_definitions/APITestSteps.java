...
public class APITestSteps {
    ...
    public void Check_that_all_of_the_data_id_values_are_four_digit_integers_and_none_of_them_are_null() {
        ...
        for (Datum datum : datumList
            ...
            Assert.assertNotNull(datum.getId());
            Assert.assertTrue(datum.getId() instanceof Integer);
            Assert.assertTrue(datum.getId().toString().matches("[0-9]{4}"));
        }
    }
    ...
    public void user_should_create_a_data_with_given_info() {
        ...
        data.setEmail("umut11@gmail.com");
        data.setName("test");
        data.setGender("male");
    ...
    public void User_should_not_crest_a_data_with_used_info() {
